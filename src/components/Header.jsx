      ...
      <div className="sticky top-0 w-full h-20 shadow-md z-[100] bg-white">
        <div className="flex justify-between items-center w-full h-full px-4 2xl:px-16 py-10">
          <Link to='/'>
            ...
            <img
              src="https://scalar.usc.edu/works/digital-writing-portfolio-4/media/writing-blogs.jpg"
              alt=""
              width={100}
              height={100}
              className="w-32 h-16"
          ...
          <div>
            <ul className="hidden md:flex items-center">
              <li className="font-bold border-b border-transparent ml-10 text-sm uppercase hover:border-b hover:border-blue-700">
                <Link to='/'>Home</Link>
              </li>
              <li className="font-bold border-b border-transparent ml-10 text-sm uppercase hover:border-b hover:border-blue-700">
